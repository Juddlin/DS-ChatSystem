...
public class EnterUserName extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        enterNameLabel.setText("Enter user name:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(enterNameField, javax.swing.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void enterNameFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enterNameFieldActionPerformed
        ...
        try {
            clientWindow = new ClientWindow(userName);
        } catch (IOException ex) {
            Logger.getLogger(EnterUserName.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(EnterUserName.class.getName()).log(Level.SEVERE, null, ex);
        }
        //clientWindow.runClient();
